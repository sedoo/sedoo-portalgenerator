...
'.$content.'
         ...
         * @return boolean
         */
        protected function _tag_open_SCRIPT($param, $other = 'script')
        {
        	if ($this->_isForOneLine) return false;
        	//$this->parsingCss->save();
        	//$this->_setNewPositionForNewLine();
         ...
         * @return boolean
         */
        protected function _tag_close_SCRIPT($param, $other = 'script')
        {
        	if ($this->_isForOneLine) return false;
        	//$this->parsingCss->save();
        	//$this->parsingCss->load();
         ...
         * @return boolean
         */
        protected function _tag_open_CENTER($param, $other = 'center')
        {
        	if ($this->_isForOneLine) return false;
        	$this->parsingCss->save();
        	$this->_setNewPositionForNewLine();
         ...
         * @return boolean
         */
        protected function _tag_close_CENTER($param, $other = 'center')
        {
        	if ($this->_isForOneLine) return false;
        	$this->parsingCss->save();
        	$this->_setNewPositionForNewLine();
         ...
         * @return boolean
         */
        protected function _tag_open_NAV($param, $other = 'nav')
        {
        	if ($this->_isForOneLine) return false;
        	$this->parsingCss->save();
        	$this->_setNewPositionForNewLine();
         ...
         * @return boolean
         */
        protected function _tag_close_NAV($param, $other = 'nav')
        {
        	if ($this->_isForOneLine) return false;
        	$this->parsingCss->save();
        	$this->_setNewPositionForNewLine();
         ...
         * @return boolean
         */
        protected function _tag_open_BUTTON($param, $other = 'button')
        {
        	if ($this->_isForOneLine) return false;
        	$this->parsingCss->save();
        	$this->_setNewPositionForNewLine();
         ...
         * @return boolean
         */
        protected function _tag_close_BUTTON($param, $other = 'button')
        {
        	if ($this->_isForOneLine) return false;
        	$this->parsingCss->save();
        	$this->_setNewPositionForNewLine();
