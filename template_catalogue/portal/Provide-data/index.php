...
<p>Large dataset providers are invited to contact  <b><?php if (defined( strtolower($project_name).'_AdminGroup_Email' ) ) echo constant(strtolower($project_name).'_AdminGroup_Email');?></b> in order to define the best way to upload the data.</p></div>
</div>
<?php
  $milieu = ob_get_clean();
