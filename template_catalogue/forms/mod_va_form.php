...
/*
	...
	function saveForm(){
		...
		$this->dataset->sites[1]->gcmd_plateform_keyword = $this->dataset->sites[1]->gcmd_plateform_keyword->getByName("Models");
		$this->dataset->sites[1]->gcmd_plat_id = & $this->dataset->sites[1]->gcmd_plateform_keyword->gcmd_plat_id;*/
