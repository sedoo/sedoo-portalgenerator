...
class mod_form extends base_form{
...
/*
		...
		$this->addElement('submit','bouton_add_variable','Add a parameter',array('onclick' => "document.getElementById('frmmod').action += '#a_param'"));

		$this->addElement('submit','bouton_add_projet','Add a project',array('onclick' => "document.getElementById('frmmod').action += '#a_general'"));
...
//		$this->dataset->sites[1]->gcmd_plat_id = $this->exportValue('model_type');
	...
	function displayForm(){
		...
		echo '<tr><th colspan="4" align="center"><a name="a_model" ></a><b>Model information</b></td></tr>';
		$this->displayErrorsModel();

		 echo '<tr><td><font color="#467AA7">'.$this->getElement('model_categ')->getLabel().'</font></td><td colspan="3">'.$this->getElement('model_categ')->toHTML().'</td></tr>';
