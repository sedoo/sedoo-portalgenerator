...
ALTER TABLE ONLY proj_inst_keyword
    ADD CONSTRAINT fk_pro_inst_keyword_instrument FOREIGN KEY (gcmd_sensor_id) REFERENCES gcmd_science_keyword(gcmd_id) ON UPDATE RESTRICT ON DELETE RESTRICT;
